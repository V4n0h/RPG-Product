let mack = [{name: 'Hunter The Reckoning', points: 10}, {name: 'Stars Without Number', points: 9}];
//[ name: 'Warhammer Fantasy' points: 8, name: 'Modern Age' points: 7, name: 'Old School Essentials' points: 6, name: 'Symbaroum' points: 5, name: 'Worlds Without Number' points: 4, name: 'Fantasy Age' points: 3, name: 'Traveller' points: 2, name: 'Death In Space' points: 1]
